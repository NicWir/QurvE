...
* maximum density considered: `r colFmt(ifelse(!is.null(grofit$control$max.density), grofit$control$min.density, "none"), 'NavyBlue')`
* maximum time considered for linear and spline fits (t0): `r colFmt(control$t0, 'NavyBlue')`

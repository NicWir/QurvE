...
plot.parameter(grofit, param = "mu.linfit", export = export, out.dir = paste0(wd, "/Plots"))
plot.parameter(grofit, param = "lambda.linfit", export = export, out.dir = paste0(wd, "/Plots"))
plot.parameter(grofit, param = "dY.linfit", export = export, out.dir = paste0(wd, "/Plots"))
```
...
plot.parameter(grofit, param = "mu.model", export = export, out.dir = paste0(wd, "/Plots"))
plot.parameter(grofit, param = "lambda.model", export = export, out.dir = paste0(wd, "/Plots"))
```
...
plot.parameter(grofit, param = "mu.spline", export = export, out.dir = paste0(wd, "/Plots"))
plot.parameter(grofit, param = "lambda.spline", export = export, out.dir = paste0(wd, "/Plots"))
plot.parameter(grofit, param = "dY.spline", export = export, out.dir = paste0(wd, "/Plots"))
```
\clearpage
...
if("all" %in% mean.grp){
  if(length(grofit$gcFit$gcFittedSplines[[1]]$spline)>1){
    plot(grofit, basesize = 15, export = export, log.y = T, mean = T, out.dir = paste0(wd, "/Plots"))
  }
    ...
    for(i in 1:length(mean.grp)){
      if(length(grep(mean.grp[i], as.character(names(grofit$gcFit$gcFittedSplines))))>0){
        plot(grofit, names = unlist(mean.grp[i]), basesize = 15, export = export, log.y = T, mean = T, out.dir = paste0(wd, "/Plots"))
      }
    }
}
if(!all(is.na(mean.conc))){
  for(i in 1:length(mean.conc)){
    if(length(grep(mean.conc[i], str_extract(names(grofit$gcFit$gcFittedSplines), "[:alnum:]+$")))>0){
      plot(grofit, conc = unlist(mean.conc[i]), basesize = 15, export = export, log.y = T, mean = T, out.dir = paste0(wd, "/Plots"))
    }
  }
}
```

...
```
```{r ec50_model_summary, echo=F, warning=F, message=F, results='asis', eval = ec50 && length(flFitRes[["drFit1"]][["drFittedModels"]]) > 0}
cat(paste0("_", length(flFitRes$drFit1$drTable$Test), "_ conditions were identified:\n",
...
```{r ec50_model_plots, fig.width=7, fig.height=5, echo=F, warning=F, message=F, fig.align='center', eval = ec50 && length(flFitRes[["drFit1"]][["drFittedModels"]]) > 0}
for(i in 1:length(flFitRes[["drFit1"]][["drFittedModels"]])){

...
```{r dual_plot_fl1, fig.width="100%", fig.height = "100%", echo=F, warning=F, message=F, results='asis', fig.align='default', eval = length(flFitRes$data$density)>1 && length(flFitRes$data$fluorescence1)>1}
...
```{r dual_plot_norm.fl1, fig.width="100%", fig.height = "100%", echo=F, warning=F, message=F, results='asis', fig.align='default', eval = length(flFitRes$data$density)>1 && length(flFitRes$data$norm.fluorescence1)>1}
...
```{r dual_plot_fl2, fig.width="100%", fig.height = "100%", echo=F, warning=F, message=F, results='asis', fig.align='default', eval = length(flFitRes$data$density)>1 && length(flFitRes$data$fluorescence2)>1}
...
```{r dual_plot_norm.fl2, fig.width="100%", fig.height = "100%", echo=F, warning=F, message=F, results='asis', fig.align='default', eval = length(flFitRes$data$density)>1 && length(flFitRes$data$norm.fluorescence2)>1}

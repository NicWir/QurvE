...
suppressWarnings(
  plot.dual(flFitRes, fluorescence = "fl", export = export)
)
```
...
suppressWarnings(
  plot.dual(flFitRes, fluorescence = "norm.fl", export = export)
)
```
...
for(i in 1:length(flFitRes[["drFit"]][["drFittedModels"]])){
  try(
    suppressWarnings(
      plot.drFitModel(flFitRes$drFit$drFittedModels[[i]], export = export)
    )
  )
}
suppressWarnings(

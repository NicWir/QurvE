...
<br/>
```{r figure, dpi = 300, out.width="100%", fig.align='center', echo = F, eval = T, message=FALSE, error=FALSE, warning=FALSE, tidy = TRUE}
knitr::include_graphics("https://i.imgur.com/qIPx0yX.png", error = F)
```

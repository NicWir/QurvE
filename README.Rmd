...
resource_files:
  - 'vignettes/vigfig-plot-parameter-1.png'
  - 'vignettes/vigfig-plot-parameter-2.png'
  - 'vignettes/vigfig-plot-parameter-3.png'
  - 'vignettes/vigfig-plot-parameter-4.png'
  - 'vignettes/vigfig-plot-parameter-5.png'
  - 'vignettes/vigfig-plot-parameter-6.png'
---
...
knitr::include_graphics("vignettes/vigfig-plot-parameter-1.png", error = F)
knitr::include_graphics("vignettes/vigfig-plot-parameter-2.png", error = F)
knitr::include_graphics("vignettes/vigfig-plot-parameter-3.png", error = F)
knitr::include_graphics("vignettes/vigfig-plot-parameter-4.png", error = F)
knitr::include_graphics("vignettes/vigfig-plot-parameter-5.png", error = F)
knitr::include_graphics("vignettes/vigfig-plot-parameter-6.png", error = F)
```

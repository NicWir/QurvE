...
```{r plot-gcBootSpline, fig.ncol = 1, fig.show="hold", out.width="85%", fig.height = 5.5, fig.pos = "H", fig.align='center', echo = T, eval = T, message=FALSE, error=FALSE, warning=FALSE, tidy = TRUE, fig.cap = "\\label{fig:plot-gcBootSpline} Nonparametric growth fit with bootstrapping."}
plot(grofit_bt$gcFit$gcBootSpline[[5]])
```
\pagebreak

...
The  argument takes the path to the file or the name of an R dataframe object containing experimental data in custom format.  specifies the separator symbol (only required for .csv files; default: `';'`).  is the decimal separator (only required for .csv, .tsv, or .txt files; default: `'.'`). If an Excel file format is used,  specifies the number or name (in quotes) of the sheet containing the data.\
If , columns with name 'blank' will be combined by their row-wise average, and the mean values will be subtracted from the measurements of all remaining samples. For the  argument, a formula can be provided in the form *'y = function(x)'* (e.g., `calib.growth = 'y = x * 2 + 0.5'`) to transform growth measurement values.
...
knitr::include_graphics("vigfig-raw-data-plot-1.png", error = F)
...
1 KT2440     1            90            TRUE       <NA> FALSE      TRUE
2 KT2440     1            70            TRUE       <NA> FALSE      TRUE
3 KT2440     1            50            TRUE       <NA> FALSE      TRUE
  log.y.spline log.y.model nboot.gc mu.linfit tD.linfit lambda.linfit dY.linfit
1         TRUE        TRUE        0         0      <NA>          <NA>         0
2         TRUE        TRUE        0         0      <NA>          <NA>         0
3         TRUE        TRUE        0         0      <NA>          <NA>         0
...
knitr::include_graphics("vigfig-group-spline-plot-1.png", error = F)
```
...
# Parameters obtained from linear regression
knitr::include_graphics("vigfig-plot-parameter-1.png", error = F)
knitr::include_graphics("vigfig-plot-parameter-2.png", error = F)

# Parameters obtained from nonparametric fits
knitr::include_graphics("vigfig-plot-parameter-3.png", error = F)
knitr::include_graphics("vigfig-plot-parameter-4.png", error = F)

# Parameters obtained from model fits
knitr::include_graphics("vigfig-plot-parameter-5.png", error = F)
knitr::include_graphics("vigfig-plot-parameter-6.png", error = F)
```
...
knitr::include_graphics("vigfig-plot-linear-1.png", error = F)
knitr::include_graphics("vigfig-plot-linear-2.png", error = F)
```
...
knitr::include_graphics("vigfig-plot-linear-update-1.png", error = F)
```
...
# Parameters obtained from linear regression
knitr::include_graphics("vigfig-plot-parameter-update-1.png", error = F)
```
...
knitr::include_graphics("vigfig-grid-plot-1.png", error = F)
```
...
knitr::include_graphics("vigfig-plot-drFit-1.png", error = F)
```
...
knitr::include_graphics("vigfig-plot-gcBootSpline-1.png", error = F)
...
knitr::include_graphics("vigfig-plot-drBootSpline-1.png", error = F)

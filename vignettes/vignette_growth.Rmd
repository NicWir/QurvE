...
```r
grodata <- read_data(data.density = system.file("2-FMA_toxicity.csv", package = "QurvE"),
                    csvsep = ";")
```
...
```
  ...
  TestId AddId concentration reliability_tag used.model
1 KT2440     1            90            TRUE       <NA>
2 KT2440     1            70            TRUE       <NA>
3 KT2440     1            50            TRUE       <NA>
  log.x log.y.lin log.y.spline log.y.model nboot.gc
